...
class JournalInvocationHandler(private val target: Any, private val journal: MethodCallJournal) : InvocationHandler {
    ...
    companion object {
        fun newInstance(obj: Any, journal: MethodCallJournal) =
